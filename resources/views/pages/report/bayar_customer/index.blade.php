...
@section('page','Bayar dari Customer')
@section('content')
<div class="row kotak-atas">
    @include('pages.report.bayar_customer.kotak_atas')
</div>
...
<script>
    $(document).ready(function(){
        ...
        $('.print').click(function(){
            ...
            let url =
            `{{ url('/report/bayarCustomer/print?tanggal_awal=`+tanggal_awal+`&tanggal_akhir=`+tanggal_akhir+`') }}`;
