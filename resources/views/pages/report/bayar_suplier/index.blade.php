...
@section('page','Bayar ke Suplier')
@section('content')
<div class="row kotak-atas">
    @include('pages.report.bayar_suplier.kotak_atas')
</div>
                ...
                <div class="row mt-3">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            @include('pages.report.bayar_suplier.table')
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    $(document).ready(function(){
        ...
        $('.print').click(function(){
            ...
            let url =
            `{{ url('/report/bayarSuplier/print?tanggal_awal=`+tanggal_awal+`&tanggal_akhir=`+tanggal_akhir+`') }}`;
