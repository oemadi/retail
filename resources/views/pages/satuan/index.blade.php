    ...
    $(function() {
		...
		.dataTable({
		   ...
		   {data: 'id',
            ...
            data1 = '<a href="/satuan/' + data + '/edit" class="btn btn-sm btn-warning">Edit</a>';
			 data2 = '<a href="/satuan/' + data + '/delete" class="btn btn-sm btn-danger" onclick="javascript:return confirm(\'Anda yakin?\');">Delete</a>';
			return data1+' '+data2;
            }
		   }
		   ]
