...
<div class="panel-body">
     <div class="panel-heading">
        	 	<legend><legend>Bukti Service CV.SIN</legend></legend>
    ...
    $(function(){
           ...
           $.ajax({
                ...
                success:function(html){
				 $('#progress_').hide();  
                 window.location.href='<?php echo site_url('laporan/print3_tagihan');?>';
                }
            })
        });
           ...
           $.ajax({
                ...
                success:function(html){
				 $('#progress_').hide();  
                 window.location.href='<?php echo site_url('laporan/report3_excel');?>';
                }
            })
        });
