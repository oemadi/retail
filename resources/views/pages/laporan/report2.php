...
<div class="panel-body">
     <div class="panel-heading">
        	 	<legend><legend>Bukti Service PT.Automata</legend></legend>
    ...
    $(function(){
           ...
           $.ajax({
                ...
                success:function(html){
				 $('#progress_').hide();  
                 window.location.href='<?php echo site_url('laporan/print2_tagihan');?>';
                }
            })
        });
           ...
           $.ajax({
                ...
                success:function(html){
				 $('#progress_').hide();  
                 window.location.href='<?php echo site_url('laporan/print2_tagihan_excel');?>';
                }
            })
        });
