...
class TransaksiController extends Controller
{
    ...
    public function create()
    {
        ...
        $kode = Transaksi::kode();
        $anggota = Anggota::get();
        return view("pages.transaksi.create", compact('kode', 'anggota', 'cart'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            $transaksi->anggota_id = (int) $request->id_anggota;
            ...
            if ($request->pembayaran == "hutang") {
                ...
                $piutang->anggota_id = $request->id_anggota;
                $piutang->transaksi_id = $transaksi->id;
                $piutang->save();
            }
            DB::commit();
            $response = Transaksi::with('anggota', 'detail_transaksi.barang')->find($transaksi->id);
